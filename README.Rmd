...
This is a basic example which shows you how to calculate wind risk through the rotation of a Sitka spruce stand, using the `df_rou_2` dataset included in the package:
