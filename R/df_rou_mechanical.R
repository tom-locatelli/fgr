#'Example input dataset for the \code{fg_rou} function with mechanical properties varying with age
#'
#'A dataset used for the example on how to use the \emph{roughness} method in the \emph{fgr} package with mechanical properties (MOE, MOR, and density of green wood) of the mean tree changing with stand age.
...
#'   \item{date}{ We think it's useful to date stands for batch/repeat simulations. Optional but mind the variables order in the `fg_rou` function call.}
...
#'   \item{moe.}{ Modulus of Elasticity (Young's modulus, Pa) of green wood. Defaults to species-specific values unless provided. Here shown to change with stand age. Advanced.}
#'   \item{mor.}{ Modulus of Rupture (Pa) of green wood. Defaults to species-specific values unless provided. Here shown to change with stand age. Advanced.}
...
#'   \item{stem_density.}{ Density (kg m-3) of the green wood of the stem. It defaults to species-specific values unless provided. Here shown to change with stand age. Advanced.}
...
#' @docType data
#' @keywords datasets
#' @name df_rou_mechanical
#' @usage data(df_rou_mechanical)
