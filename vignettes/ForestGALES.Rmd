...
```{r pressure, echo=FALSE, fig.cap="Figure 1: Applied and resistive forces on a tree subject to strong winds (from Peltola, 2006)", out.width = '100%'}
knitr::include_graphics("Peltola_2006.png")
```
